...
public class CacheUtil
{
	...
	//数据缓存
	private static Cache mmecCache;
	//请求统计缓存
	private static Cache vptCache;
	//请求统计缓存
	private static Cache vptConfigCache;
	//存证缓存
	private static Cache evidenceCache;
...
//		Cache ss =  CacheManager.getInstance().getCache("signCache");
//		List list = ss.getKeys();
//		Element e =  ss.get("signCache");
