...
public class SftpUtils {
    ...
    private static String ftpHost = "10.248.28.57";

    private static String port = "22";

    private static String ftpUserName = "scapp";

    private static String ftpPassword = "Pcitc2017!";


    public void setFtpHost(String ftpHost) {
        SftpUtils.ftpHost = ftpHost;
    }
    ...
    public void setFtpUserName(String ftpUserName) {
        SftpUtils.ftpUserName = ftpUserName;
    }
    ...
    private static boolean uploadFiles(ChannelSftp channel, String remoteFoldPath,
        ...
        for (File localFile : localFiles) {
            ...
            if (localFile.isDirectory()) {
                uploadFiles(channel, localFile.getName(), Arrays.asList(localFile.listFiles()));
...
//        System.out.println(SftpUtils.uploadFiles("test1/test2/test3/test4", "E:\\test\\test5", "E:\\test\\test7"));
//        System.out.println(rm("test1/test2/test3/test4"));

//        File file = new File("e:\\test\\test5\\new 2.log");
//        try(InputStream input = new FileInputStream(file)) {
//            System.out.println(uploadFile(input, "test1/test2/test3/test4", "my.log"));
//            byte[] bytes = new byte[(int)(file.length() + 10)];
//            input.read(bytes);
//            System.out.println(uploadFile(bytes, "test1/test2/test3/test4", "my.log"));
...
//        downloadFile("WordRqmErrors.log", "test1", "e://WordRqmErrors.log");

        System.out.println(downloadFiles("e:\\test\\test10", "test1/test2/test3/test4/test5",
                "test1/test2/test3/test4/test7"));
    }
}
