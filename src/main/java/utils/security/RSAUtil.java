...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            byte[] enRsaBytes = rsa.encrypt(pubKey,str.getBytes(charset));
            String enRsaStr = new String(enRsaBytes, charset);
            System.out.println("加密后==" + enRsaStr);
            System.out.println("解密后==" + new String(rsa.decrypt(priKey, rsa.encrypt(pubKey,str.getBytes(charset))), charset));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
