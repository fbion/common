package demo.jfreechart.example1;
 ...
 * <p>类描述：</p>
 * 创建人：zhouzhihui<br/>
 * 创建时间：2017/3/22 14:16<br/>
 * 修改人：周志辉<br/>
 * 修改时间：2017/3/22 14:16<br/>
 * 修改备注：<br/>
 *
 * @version 1.0<br/>
 */
...
//        chartTheme.setBaselinePaint(Color.WHITE);//////////////////////////////////////////////////////////////////
    ...
    public static void setTimeSeriesRender(Plot plot, boolean isShowData, boolean isShapesVisible) {
        ...
        DateTickUnit dateTickUnit = new DateTickUnit(DateTickUnit.YEAR, 1, new SimpleDateFormat("yyyy-MM")); // 第二个参数是时间轴间距
