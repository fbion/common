(function () {
    var ah = window, l = document, A = navigator, ag = A.userAgent, p = ah.screen, s;
    try {
        s = ah.location.href
    } catch (au) {
        s = document.URL
    }
    var af = "https:" == ah.location.protocol ? "https://s" : "http://", v = "beacon.sina.com.cn";
    var q = af + v + "/a.gif?", Q = af + v + "/g.gif?", z = af + v + "/d.gif?", f = af + v + "/e.gif?";
    var c = 0;
    var U = l.referrer.toLowerCase();
    var E = "SINAGLOBAL", b = "Apache", al = "ULV", n = "SUP", ao = "UOR", ab = "_s_acc", S = "_s_tentry";
    var am = 0;
    var y = false;
    var aj = false, j = false;
    var ai = "";
    var aa = 16777215, I = 0, W, d = 0;
    var ak = "", H = "", G = "";
    var k = [], K = [], ac = [];
    var aw = 0;
    var Z = (function () {
        var i = window.localStorage, D, ax;
        if (i) {
            return {
                get: function (e) {
    ...
    function R(ax, aB) {
        ...
        for (var az = 0, aA = aD.length; az < aA; az++) {
            if (aD[az]) {
                var ay = aD[az].split("=");
                var e = ay[0];
                var aE = ay[1];
    ...
    function m(D, ay) {
        for (var ax = 0, e = D.length; ax < e; ax++) {
            ay(D[ax], ax)
        }
    }
    ...
    var x = {
        screenSize: function () {
            ...
            var ay, e, aA, D = 1, ax = 0, i = (A.appName.indexOf("Microsoft Internet Explorer") > -1) ? "MSIE" : A.appName, az = A.appVersion;
            if ("MSIE" == i) {
                e = "MSIE";
                ay = az.indexOf(e);
                if (ay >= 0) {
            ...
            var D = A.plugins, i = A.javaEnabled(), ax, ay;
            if (i == true) {
                return 1
            }
            if (D && D.length) {
    ...
    var P = {
        visitorId: function () {
            ...
            var ay = h(ao), aC = "", e = "", aB = "", D = "", az = s.toLowerCase(), i = l.referrer.toLowerCase();
    ...
    var av = {
        picList: [{
            ...
            size: 23243
        }, {url: "http://ww4.sinaimg.cn/large/53d96fe3tw1diw52tyd28j.jpg", size: 23243}],
        picOk: false,
        picData: [],
        picture: function () {
            if ((I & 8) != 8) {
            ...
            var az = [], D;
            for (var ay = 0, e = av.picList.length; ay < e; ay++) {
                D = new Image();
                SUDA.img = D;
        ...
        porList: [{
            ...
            size: 3456
        }, {url: "http://tp4.sinaimg.cn/1245851035/50/1279876078/1", size: 2519}],
        porOk: false,
        porData: [],
        portait: function () {
            if ((I & 4) != 4) {
            ...
            var ax = new Date().getTime();
            var az = [], D;
            for (var ay = 0, e = av.porList.length; ay < e; ay++) {
                D = new Image();
                SUDA.img = D;
        ...
        jsList: [{url: "http://js.t.sinajs.cn/t4/home/static/suda/feed.png", size: 21287}],
        jsOk: false,
        jsData: [],
        jsSpeed: function () {
            if ((I & 2) != 2) {
            ...
            var ax = new Date().getTime();
            var az = [], D;
            for (var ay = 0, e = av.jsList.length; ay < e; ay++) {
                D = new Image();
                SUDA.img = D;
        ...
        cssList: [{url: "http://img.t.sinajs.cn/t4/style/images/mobile/android/cp_3.jpg", size: 24472}],
        cssOk: false,
        cssData: [],
        cssSpeed: function () {
            if ((I & 1) != 1) {
            ...
            var ax = new Date().getTime();
            var az = [], D;
            for (var ay = 0, e = av.cssList.length; ay < e; ay++) {
                D = new Image();
                SUDA.img = D;
    ...
    function M() {
        var aA = "-", ax = l.referrer.toLowerCase(), D = s.toLowerCase();
        if ("" == h(S)) {
            if ("" != ax) {
                aA = T(ax)
            }
    ...
    function F(aB) {
        ...
        if (aD) {
            ...
            ax.key && SUDA.uaTrack && SUDA.uaTrack(ax.key, ax.value || ax.key, {href: i, realUrl: aA, urls: ay})
        }
        if (az) {
            ax = R(az);
        ...
        if (/^[-\d]/.test(aF)) {
            ...
            switch (aG) {
                ...
                case"sibling":
                    ...
                    for (var ay = 0, aC = D.length; ay < aC; ay++) {
                ...
                case"child":
                    ...
                    for (var ax = 0, aA = D.length; ax < aA; ax++) {
    ...
    if (window.SUDA && Object.prototype.toString.call(window.SUDA) === "[object Array]") {
        for (var ap = 0, B = SUDA.length; ap < B; ap++) {
            switch (SUDA[ap][0]) {
                case"setGatherType":
                    aa = SUDA[ap][1];
                    break;
